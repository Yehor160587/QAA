...
public class QAA2 {
    ...
    static void year() {
        ...
        movieSearch.sendKeys("Die Hard");
        searchBtn.click();
        WebElement filmYear = new WebDriverWait(driver, Duration.ofSeconds(30)).until(elementToBeClickable(By.id("api_year")));
    ...
    static void title() {
        ...
        searchBtn.click();
        WebElement filmTitle = new WebDriverWait(driver, Duration.ofSeconds(30)).until(elementToBeClickable(By.id("api_title")));
    ...
    static String undefined() {
        ...
        WebElement movieSearch = driver.findElement(By.id("film_name"));
        WebElement searchBtn = driver.findElement(By.id("get_api_res_btn"));
        movieSearch.sendKeys("undefined");
        searchBtn.click();
        WebElement filmTitle = new WebDriverWait(driver, Duration.ofSeconds(30)).until(elementToBeClickable(By.id("api_title")));
        WebElement filmYear = new WebDriverWait(driver, Duration.ofSeconds(30)).until(elementToBeClickable(By.id("api_year")));
        WebElement directorName = new WebDriverWait(driver, Duration.ofSeconds(30)).until(elementToBeClickable(By.id("api_director")));
        String y= "assert pass";
        String w = "assert fail";
        String[] z = {filmTitle.getText().substring(11), directorName.getText().substring(10), filmYear.getText().substring(6)};
        for (int q = 0; q < z.length - 1; q++)
            if (z[q].equals("undefined")) {
                return y;
            }
        return w;
    }
